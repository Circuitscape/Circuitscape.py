...
{'type':'CheckBox', 
    ...
    'position':(374, 381), 
    'size':(180, 20), 
    'font':{'faceName': u'Lucida Grande', 'family': 'sansSerif', 'size': 10},#  'size': 11}, 
...
{'type':'Choice', 
    ...
    'position':(27, 54), 
    'size':(250, -1), 
    'font':{'faceName': 'Lucida Grande', 'family': 'sansSerif', 'size': 10},#  'size': 12}, 
...
{'type':'Choice', 
    ...
    'position':(27, 107), 
    'size':(458, -1), 
    'font':{'faceName': 'Lucida Grande', 'family': 'sansSerif', 'size': 11},#  'size': 12}, 
...
{'type':'CheckBox', 
    ...
    'position':(27, 223), 
    'size':(437, 21), 
    'font':{'faceName': u'Arial', 'family': 'sansSerif', 'size': 10},#  'size': 11}, 
...
{'type':'Button', 
    ...
    'position':(395, 315), 
    'size':(-1, 23), 
    'font':{'faceName': u'Lucida Grande', 'family': 'default', 'size': 10},#  'size': 11}, 
    'label':'Browse', 
    },
...
{'type':'StaticText', 
    ...
    'position':(29, 345), 
    'font':{'style': 'bold', 'faceName': u'Lucida Grande', 'family': 'sansSerif', 'size': 10},#  'size': 11}, 
    'foregroundColor':(0, 0, 160, 255), 
...
{'type':'Button', 
    ...
    'position':(857, 321), 
    'size':(100, 23), 
    'font':{'style': 'bold', 'faceName': u'Lucida Grande', 'family': 'sansSerif', 'size': 12},#  'size': 13}, 
    'label':'RUN', 
    },
...
{'type':'Choice', 
    ...
    'position':(226, 381), 
    'size':(80, -1), 
    'font':{'faceName': u'Lucida Grande', 'family': 'sansSerif', 'size': 8},#  'size': 9}, 
...
{'type':'StaticText', 
    'name':'outputOptions', 
    'position':(523, 215), 
    'font':{'style': 'bold', 'faceName': 'Lucida Grande', 'family': 'sansSerif', 'size': 12},#  'size': 13}, 
    'foregroundColor':(0, 0, 160, 255), 
    'text':'Output options', 
    },
...
{'type':'StaticText', 
    'name':'outFileText', 
    'position':(536, 236), 
    'font':{'style': 'bold', 'faceName': 'Lucida Grande', 'family': 'sansSerif', 'size': 10},#  'size': 11}, 
    'foregroundColor':(0, 0, 160, 255), 
...
{'type':'StaticText', 
    'name':'CIRCUITSCAPE', 
    'position':(490, 2), 
    'font':{'style': 'bold', 'faceName': u'Arial', 'family': 'sansSerif', 'size': 20},#  'size': 26}, 
